"""Experimental: not wired into the runtime. Kept for reference.

Task scheduling for DAG execution. The Scheduler abstraction was designed
for a future multi-worker executor; it is currently unused.
"""
